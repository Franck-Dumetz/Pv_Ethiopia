...
# Paths and settings
HISAT2_INDEX="/local/projects-t3/SerreDLab-3/kko/mdr_del_search_dna_whole_genome/check_for_other_plasmodium_dir/all_plasmodium_genomes_no_MIT/all_plasmodium_genomes_no_MIT_index"  # Replace with your HISAT2 index base name
...
ALIGN_OUTPUT_DIR="/local/projects-t3/SerreDLab-3/fdumetz/Pv_ethiopia/MultiSpecies/5sp_aligned"  # Directory for aligned BAM files
SUM_DIR="/local/projects-t3/SerreDLab-3/fdumetz/Pv_ethiopia/MultiSpecies/5sp_aligned/sum_dir"
